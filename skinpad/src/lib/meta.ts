const DEFAULT_TITLE = 'CS2 SKINPAD — Launch tokens backed by CS2 skins'
const DEFAULT_DESC = 'Pick any CS2 skin in the catalogue and launch a token pegged to it, one to one.'
...
export function setDocumentMeta(input: {
  ...
  const image = input.image || '/brand/banner-metal.jpg'
