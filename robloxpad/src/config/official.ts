...
export const ROBLOXPAD_TICKER = 'ROBLOXPAD'
export const ROBLOXPAD_NAME = 'RobloxPad'
export const ROBLOXPAD_X_URL = env('VITE_ROBLOXPAD_X') || 'https://x.com/RobloxPad'
export const ROBLOXPAD_TG_URL = env('VITE_ROBLOXPAD_TG') || 'https://t.me/RobloxPad'
export const ROBLOXPAD_SITE = 'https://robloxpad.family'

/** Official $ROBLOXPAD — 19:00 Europe/Istanbul on 11 Sep 2026. */
export const OFFICIAL_LAUNCH_AT = env('VITE_ROBLOXPAD_LAUNCH_AT') || '2026-09-11T16:00:00.000Z'

export const ROBLOXPAD_OFFICIAL_TOKEN = officialAddress(
  'VITE_ROBLOXPAD_TOKEN',
  '0x333dA56faeE6c18FD65C7aAF95a96916c4BdfE9A',
)

export function isOfficialToken(address: string): boolean {
  if (!ROBLOXPAD_OFFICIAL_TOKEN) return false
  return address.toLowerCase() === ROBLOXPAD_OFFICIAL_TOKEN.toLowerCase()
}
...
export function configuredIntegrations() {
  return {
    ...
    officialToken: Boolean(ROBLOXPAD_OFFICIAL_TOKEN),
  }
}
