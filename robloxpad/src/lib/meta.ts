const DEFAULT_TITLE = 'RobloxPad — Play the game. Earn on it.'
const DEFAULT_DESC = 'Play a live Roblox game. Launch a token on it. Trade while they play.'
...
export function setDocumentMeta(input: {
  ...
  const image = input.image || '/brand/banner.jpg'
